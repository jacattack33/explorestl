...
{
    //Depreciated, do not use. Use CSV import in sql tool of choice instead
    //Converted for one time use to populate DB. Running main should pull in all entries from the CSV and populate the DB.
    public class DataParser
    {
        ...
        private readonly SightDbContext context;
